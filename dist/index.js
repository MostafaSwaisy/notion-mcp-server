...
const notion_js_1 = require("./services/notion.js");
...
class NotionMCPServer {
    constructor() {
        ...
        this.notionService = new notion_js_1.NotionService(config_js_1.config.notionApiKey);
        this.setupHandlers();
    }
    setupHandlers() {
            ...
            try {
                ...
                switch (name) {
                    ...
                    case 'notion_create_page':
                        ...
                        return await this.notionService.createPage(toolArgs.title, typeof toolArgs.content === 'string' ? toolArgs.content : undefined, typeof toolArgs.parentId === 'string' ? toolArgs.parentId : undefined);
                    case 'notion_update_page':
                        if (typeof toolArgs.pageId !== 'string') {
                            throw new Error('pageId must be a string');
                        }
                        return await this.notionService.updatePage(toolArgs.pageId, typeof toolArgs.title === 'string' ? toolArgs.title : undefined, typeof toolArgs.content === 'string' ? toolArgs.content : undefined);
                    case 'notion_search':
                        if (typeof toolArgs.query !== 'string') {
                            throw new Error('query must be a string');
                        }
                        return await this.notionService.search(toolArgs.query, typeof toolArgs.filter === 'object' && toolArgs.filter !== null ? toolArgs.filter : undefined, typeof toolArgs.sort === 'object' && toolArgs.sort !== null ? toolArgs.sort : undefined);
                    case 'notion_append_blocks':
                        ...
                        return await this.notionService.appendBlocks(toolArgs.pageId, toolArgs.blocks);
